...
public class TrialGame extends Application {
	...
	public void start(Stage primaryStage) {
		...
		Image whiteSquare = new Image("file:C:/Users/chand/Downloads/white.png");
		Image blackSquare = new Image("file:C:/Users/chand/Downloads/black.png");
		
		//ImageView[][] squareImages = new ImageView[6][6];
		...
		for (int i=0; i<6; i++) {
			for (int j=0; j<6; j++) {
				...
				// whenever a square is clicked print to console
				square.setOnMouseClicked(e -> {
					ImageView spotClicked = (ImageView) e.getSource();
